...
export const AdhocIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const DataIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
);
...
export const KpiTotalIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const KpiPlanIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const KpiAdhocIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const KpiPointsIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const GanttChartIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ClipboardCheckIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M9 12h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
    </svg>
);
...
export const PlanningIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M7.5 12h9m-9 3h6" />
    </svg>
);
export const OkrIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 15a3 3 0 100-6 3 3 0 000 6z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m0 13.5V21m-6.75-9H3m15.75 0h-2.25" />
    </svg>
);
...
export const DriveIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M7.71,3.5,1.15,15.29a0.75,0.75,0,0,0,.65,1.14l21.5,0a0.75,0.75,0,0,0,.65-1.14L16.29,3.5a0.75,0.75,0,0,0,-1.3,0L12,8.25,9,3.5a0.75,0.75,0,0,0,-1.3,0Z" />
        <path d="M8.33,5,12,11.75,15.67,5h-7.33Z" fillOpacity="0.15" />
        <path d="M12,11.75,15.67,5l-4.33,7.5-3.67-6.25,4.33,7.5Z" fillOpacity="0.05" />
    </svg>
);
export const FigmaIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        ...
        <path d="M8 12a4 4 0 014-4h4v8a4 4 0 01-8 0z" fill="#0ACF83"/>
        <path d="M12 8a4 4 0 00-4 4v4a4 4 0 108 0v-4a4 4 0 00-4-4z" fill="#A259FF"/>
        <path d="M12 8a4 4 0 00-4 4v4a4 4 0 008 0v-4a4 4 0 00-4-4z" fill="#F24E1E"/>
        <path d="M12 12a4 4 0 014 4H8a4 4 0 014-4z" fill="#FF7262"/>
        <path d="M16 12a4 4 0 010 8V8a4 4 0 010 4z" fill="#1ABCFE"/>
    </svg>
);
...
export const DocumentMagnifyingGlassIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m5.231 13.481L15 17.25m-4.5 4.5l-1.548-1.548a2.25 2.25 0 010-3.182l2.25-2.25a2.25 2.25 0 013.182 0l1.548 1.548a2.25 2.25 0 010 3.182l-2.25 2.25a2.25 2.25 0 01-3.182 0zM12 18.75a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75H12a.75.75 0 01-.75-.75v-.008z" />
    </svg>
);
...
export const Bars3BottomLeftIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
    </svg>
);
